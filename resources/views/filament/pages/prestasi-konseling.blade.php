<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <div class="p-4 mb-6 bg-gray-100 rounded-md shadow-md dark:bg-gray-800">
            <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-gray-100">Informasi Konseling Siswa</h3>
        ...
        <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Riwayat Prestasi</h2>

        @if ($violations->isEmpty())
            <p class="text-gray-900 dark:text-gray-100">Tidak ada riwayat Prestasi.</p>
        @else
                ...
                <table class="w-full text-sm text-gray-700 bg-white border-collapse rounded-sm dark:text-gray-300 dark:bg-gray-900">
                    <thead>
                        <tr class="bg-gray-200 border-b dark:bg-gray-100">
                            ...
                            <th class="border border-gray-300 dark:border-gray-600 p-2 uppercase w-[20%]">Jenis Prestasi</th>
                    ...
                    <tbody>
                        @foreach ($violations as $index => $violation)
                            <tr class="{{ $loop->even ? 'bg-gray-50 dark:bg-gray-100' : 'bg-white dark:bg-gray-100' }}">
                                ...
                                <td class="p-2 text-center break-words border border-gray-300 dark:border-gray-600">{{ $violation->prestasi }}</td>
